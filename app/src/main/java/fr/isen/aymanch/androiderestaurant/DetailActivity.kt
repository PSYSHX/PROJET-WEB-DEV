                ...
                HorizontalPager(state = pagerState) {
                    AsyncImage(
                        model = ImageRequest.Builder(LocalContext.current)
                            ...
                            .build(),
                        null,
                        placeholder = painterResource(R.drawable.image_404),
                        error = painterResource(R.drawable.image_404),
...
@Composable
fun DishPriceBox(dish: fr.isen.aymanch.androiderestaurant.network.Dish?, quantity: Int) {
